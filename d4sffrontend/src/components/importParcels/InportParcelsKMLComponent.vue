<template>
    <div class="bx--grid">
        ...
        <div id="txt-explicativo" class="bx--row">
            <div class="bx--col">
                <h2>Importar Parcelas desde .kml o .kmz <img src="../../assets/agriculture-analytics.svg" style="width: 40px;"></h2>
            </div>
        </div>
        <br>
        <div id="txt-explicativo" class="bx--row">
...
export default {
    ...
    methods: {
        ...
        importarParcelas(){
            ...
            importParcelsFromFileKML(this.file[0].file, this.selectValueEmpresa, false)
            .then(response => {
        ...
        importarParcelasConfirmar(){
            ...
            console.info('Importando parcelas')
            this.isActiveLoading = true
            importParcelsFromFileKML(this.file[0].file, this.selectValueEmpresa, true)
            .then((response) => {
