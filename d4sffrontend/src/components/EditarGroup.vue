...
export default {
    ...
    data() {
        return {
            ...
            invalidMessageName: '',
            //input-email
            labelDesc: 'Descripción del Grupo',
            valueDesc: '',
            disabledDesc: false,
            inputTypeDesc: 'text',
    ...
    methods: {
        openModal(userSelec) {
            this.$refs.editarGroupForm.show();
            
            this.showPassword = false
            this.title_card = 'Editar Grupo',
            this.subtitle_card = 'Editar Grupo:'
            this.userSeleccionado = userSelec;
            const path = `${this.$apiURL}/groups/${this.userSeleccionado}/`;
            axios
                .get(path)
                .then(response => {
                ...
                .catch( () => {
                    ...
                    this.title_card = 'Nuevo Grupo'
                    this.subtitle_card = 'Crear nuevo Grupo'
                    this.valueName = '';
                    this.valueDesc = '';
                });
        },
        actionPrimary() {
            ...
            if(this.userSeleccionado){
                path = `${this.$apiURL}/groups/${this.userSeleccionado}/`;
                axios
                .put(path, {
                ...
                .then(response => {
                    ...
                    this.$refs.editarGroupForm.hide();
