...
(function (global, factory) {
	...
	*/
	...
	var find$1 = function (it) {
	  var own = it.find;
	  return it === ArrayPrototype$2 || (objectIsPrototypeOf(ArrayPrototype$2, it) && own === ArrayPrototype$2.find) ? find : own;
	};
	...
	var map$1 = function (it) {
	  var own = it.map;
	  return it === ArrayPrototype$3 || (objectIsPrototypeOf(ArrayPrototype$3, it) && own === ArrayPrototype$3.map) ? map : own;
	};
	...
	var includes$2 = function (it) {
	  var own = it.includes;
	  if (it === ArrayPrototype$4 || (objectIsPrototypeOf(ArrayPrototype$4, it) && own === ArrayPrototype$4.includes)) return includes;
	...
	var concat$3 = function (it) {
	  var own = it.concat;
	  return it === ArrayPrototype$5 || (objectIsPrototypeOf(ArrayPrototype$5, it) && own === ArrayPrototype$5.concat) ? concat$2 : own;
	};
	...
	function coalesce() {
	  ...
	  return find$3(args).call(args, function (val) {
	    return val != null;
	  });
	}
	/**
	...
	function replaceTokens(string, replaces) {
	  ...
	  var regExp = new RegExp(map$3(_context2 = keys$2(replaces)).call(_context2, function (field) {
	    return '(\\{' + field + '\\})';
	  }).join('|'), 'ig');
	...
	function pick(object, key) {
	  ...
	  if (Array.isArray(key)) {
	    ...
	    keys = concat$5(_context3 = [key]).call(_context3, keys);
	  }
	...
	function upperFirst(string) {
	  ...
	  return string[0].toUpperCase() + slice$3(string).call(string, 1);
	}
	function lowerFirst(string) {
	  ...
	  return string[0].toLowerCase() + slice$3(string).call(string, 1);
	}
	...
	function get$1(obj, path, defaultValue) {
	  var travel = function travel(regexp) {
	    ...
	    return filter$3(_context6 = String.prototype.split.call(path, regexp)).call(_context6, Boolean).reduce(function (res, key) {
	...
	function includes$5(array, value) {
	  ...
	  var elems = filter$4(array, function (elem) {
	...
	function difference(array1, array2) {
	  var comparator = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : isEqual;
	  return filter$4(array1, function (value) {
	...
	if ($stringify$1) {
	  ...
	  _export({ target: 'JSON', stat: true, forced: FORCED$2 }, {
	    ...
	    stringify: function stringify(it, replacer, space) {
	      ...
	      var result = functionApply($stringify$1, null, args);
	...
	function ownKeys$1(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var functionBind = Function$1.bind || function bind(that /* , ...args */) {
	  ...
	  var boundFunction = function bound(/* args... */) {
	    var args = concat$6(partArgs, arraySlice(arguments));
	...
	var getPrototypeOf$3 = getPrototypeOf$1;

	var getPrototypeOf$4 = getPrototypeOf$3;

	function _getPrototypeOf(o) {
	  _getPrototypeOf = setPrototypeOf$3 ? getPrototypeOf$4 : function _getPrototypeOf(o) {
	...
	function _get(target, property, receiver) {
	  if (typeof Reflect !== "undefined" && get$6) {
	    _get = get$6;
	  } else {
	...
	function _setPrototypeOf(o, p) {
	  _setPrototypeOf = setPrototypeOf$3 || function _setPrototypeOf(o, p) {
	    o.__proto__ = p;
	    return o;
	  };
	...
	function lineToLonLat(coordinates) {
	  var projection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : EPSG_3857;
	  return map$3(coordinates).call(coordinates, function (point) {
	...
	function polygonToLonLat(coordinates) {
	  var projection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : EPSG_3857;
	  return map$3(coordinates).call(coordinates, function (line) {
	...
	function multiPolygonToLonLat(coordinates) {
	  var projection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : EPSG_3857;
	  return map$3(coordinates).call(coordinates, function (polygon) {
	...
	function writeGeoJsonFeature(feature) {
	  ...
	  if (Array.isArray(get$1(geoJsonFeature, 'properties.features'))) {
	    ...
	    geoJsonFeature.properties.features = map$3(_context = geoJsonFeature.properties.features).call(_context, function (feature) {
	...
	function readGeoJsonFeature(geoJsonFeature) {
	  ...
	  if (Array.isArray(feature.get('features'))) {
	    ...
	    feature.set('features', map$3(_context2 = feature.get('features')).call(_context2, function (feature) {
	...
	function ownKeys$2(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function defaultEditStyle() {
	  ...
	  styles[GEOMETRY_TYPE.POLYGON] = concat$5(_context = [{
	    fillColor: [255, 255, 255, 0.5]
	  }]).call(_context, styles[GEOMETRY_TYPE.LINE_STRING]);
	  styles[GEOMETRY_TYPE.MULTI_POLYGON] = styles[GEOMETRY_TYPE.POLYGON];
	  styles[GEOMETRY_TYPE.CIRCLE] = concat$5(_context2 = styles[GEOMETRY_TYPE.POLYGON]).call(_context2, styles[GEOMETRY_TYPE.LINE_STRING]);
	  ...
	  styles[GEOMETRY_TYPE.GEOMETRY_COLLECTION] = concat$5(_context3 = styles[GEOMETRY_TYPE.POLYGON]).call(_context3, styles[GEOMETRY_TYPE.LINE_STRING], styles[GEOMETRY_TYPE.POINT]);
	  return styles;
	}
	...
	function createFillStyle(vlStyle) {
	  ...
	  var keys = map$3(_context4 = ['fillColor']).call(_context4, prefixKey);
	  ...
	  var fillStyle = reduce(vlStyle, function (style$$1, value, name) {
	...
	function createStrokeStyle(vlStyle) {
	  ...
	  var keys = map$3(_context5 = ['strokeColor', 'strokeWidth', 'strokeMiterLimit', 'strokeCap', 'strokeJoin', 'strokeDash', 'strokeDashOffset']).call(_context5, prefixKey);

	  var compiledKey = prefixKey('stroke');
	  if (vlStyle[compiledKey] instanceof Stroke) return vlStyle[compiledKey];
	  var strokeStyle = reduce(vlStyle, function (style$$1, value, name) {
	    if (includes$4(keys).call(keys, name) === false) {
	      return style$$1;
	    }
	...
	function createTextStyle(vlStyle) {
	  ...
	  var font = filter$3(_context6 = [vlStyle.textFontWeight, fontSize, fontName]).call(_context6, function (x) {
	    return !!x;
	  }).join(' ');
	...
	function extractChildren(slots) {
	  ...
	  return keys$2(slots).reduce(function (all, name) {
	    if (!slotNames.length || includes$4(slotNames).call(slotNames, name)) {
	      all = concat$5(all).call(all, slots[name]);
	    }
	...
	function ownKeys$3(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	***************************************************************************** */
	...
	function map$5(project, thisArg) {
	...
	var iterator$4 = /*@__PURE__*/ getSymbolIterator();

	/** PURE_IMPORTS_START _symbol_iterator PURE_IMPORTS_END */
	var subscribeToIterable = function (iterable) {
	    return function (subscriber) {
	        var iterator$$1 = iterable[iterator$4]();
	        do {
	            var item = void 0;
	            try {
	...
	var subscribeTo = function (result) {
	    ...
	    else if (!!result && typeof result[iterator$4] === 'function') {
	...
	function isIterable(input) {
	    return input && typeof input[iterator$4] === 'function';
	}
	...
	function mergeMap(project, resultSelector, concurrent) {
	    ...
	    if (typeof resultSelector === 'function') {
	        return function (source$$1) { return source$$1.pipe(mergeMap(function (a, i) { return from$1(project(a, i)).pipe(map$5(function (b, ii) { return resultSelector(a, b, i, ii); })); }, concurrent)); };
	    }
	...
	var iterate = function (iterable, unboundFunction, options) {
	  ...
	  var stop = function (condition$$1) {
	    if (iterator) iteratorClose(iterator, 'normal', condition$$1);
	...
	collection('Map', function (init) {
	  return function Map$$1() { return init(this, arguments.length ? arguments[0] : undefined); };
	}, collectionStrong);
	...
	var collectionFrom = function from(source$$1 /* , mapFn, thisArg */) {
	  ...
	  if (mapping) {
	    ...
	    iterate(source$$1, push$5, { that: array });
	  }
	...
	_export({ target: 'Map', proto: true, real: true, forced: isPure }, {
	  reduce: function reduce(callbackfn /* , initialValue */) {
	    ...
	    if (noInitial) throw TypeError$g('Reduce of empty map with no initial value');
	    return accumulator;
	  }
	});
	...
	_export({ target: 'Map', proto: true, real: true, forced: isPure }, {
	  update: function update(key, callback /* , thunk */) {
	    ...
	    if (!isPresentInMap && length < 3) {
	      throw TypeError$h('Updating absent value');
	    }
	...
	var mapUpsert = function upsert(key, updateFn /* , insertFn */) {
	  ...
	  if (!isCallable(updateFn) && !isCallable(insertFn)) {
	    throw TypeError$i('At least one callback required');
	  }
	...
	var indexOf$2 = function (it) {
	  var own = it.indexOf;
	  return it === ArrayPrototype$7 || (objectIsPrototypeOf(ArrayPrototype$7, it) && own === ArrayPrototype$7.indexOf) ? indexOf$1 : own;
	};
	...
	function _isNativeReflectConstruct$1() {
	  if (typeof Reflect === "undefined" || !construct$6) return false;
	  if (construct$6.sham) return false;
	  if (typeof Proxy === "function") return true;

	  try {
	    Boolean.prototype.valueOf.call(construct$6(Boolean, [], function () {}));
	    return true;
	  } catch (e) {
	    return false;
	  }
	...
	function _construct(Parent, args, Class) {
	  if (_isNativeReflectConstruct$1()) {
	    _construct = construct$6;
	  } else {
	    _construct = function _construct(Parent, args, Class) {
	      var a = [null];
	      a.push.apply(a, args);

	      var Constructor = bind$7(Function).apply(Parent, a);
	...
	function _wrapNativeSuper(Class) {
	  ...
	  _wrapNativeSuper = function _wrapNativeSuper(Class) {
	    ...
	    Wrapper.prototype = create$3(Class.prototype, {
	      constructor: {
	        value: Wrapper,
	        enumerable: false,
	        writable: true,
	...
	var splice$1 = function (it) {
	  var own = it.splice;
	  return it === ArrayPrototype$8 || (objectIsPrototypeOf(ArrayPrototype$8, it) && own === ArrayPrototype$8.splice) ? splice : own;
	};
	...
	var rxSubs = {
	  methods: {
	    ...
	    subscribeTo: function subscribeTo(observable) {
	      ...
	      var _error = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : noop$1;
	    ...
	    unsubscribe: function unsubscribe(subs) {
	      ...
	      splice$3(_context = this._rxSubs).call(_context, idx, 1);
	    }
	  },
	...
	var identMap = {
	  ...
	  methods: {
	    ...
	    makeSelfIdent: function makeSelfIdent() {
	      ...
	      return this.makeIdent.apply(this, concat$5(_context = [this.ident]).call(_context, parts));
	    },
	    ...
	    makeIdent: function makeIdent() {
	      ...
	      return filter$3(parts).call(parts, identity).join('.');
	    },
	...
	function _arrayWithoutHoles(arr) {
	  if (isArray$6(arr)) return _arrayLikeToArray(arr);
	}
	...
	function _iterableToArray(iter) {
	  if (typeof symbol$3 !== "undefined" && getIteratorMethod$3(iter) != null || iter["@@iterator"] != null) return from_1$4(iter);
	}
	...
	function fromEventPattern(addHandler, removeHandler, resultSelector) {
	    if (resultSelector) {
	        return fromEventPattern(addHandler, removeHandler).pipe(map$5(function (args) { return isArray$2(args) ? resultSelector.apply(void 0, args) : resultSelector(args); }));
	    }
	    return new Observable(function (subscriber) {
	...
	function fromOlEvent(target, eventName, selector) {
	  if (Array.isArray(eventName)) {
	    return merge.apply(void 0, _toConsumableArray(map$3(eventName).call(eventName, function (elem) {
	...
	function fromOlChangeEvent(target, prop, distinct, debounce, selector) {
	  if (Array.isArray(prop)) {
	    return merge.apply(void 0, _toConsumableArray(map$3(prop).call(prop, function (p) {
	  ...
	  operations.push(map$5(function (value) {
	    return {
	      prop: prop,
	      value: value
	    };
	...
	var featuresContainer = {
	  ...
	  computed: {
	    featureIds: function featureIds() {
	      ...
	      if (!this.rev) return [];
	      return map$3(_context = this.getFeatures()).call(_context, getFeatureId);
	    },
	    featuresViewProj: function featuresViewProj() {
	      var _context2;

	      if (!this.rev) return [];
	      return map$3(_context2 = this.getFeatures()).call(_context2, this.writeFeatureInViewProj.bind(this));
	    },
	    featuresDataProj: function featuresDataProj() {
	      var _context3;

	      if (!this.rev) return [];
	      return map$3(_context3 = this.getFeatures()).call(_context3, this.writeFeatureInDataProj.bind(this));
	    },
	  ...
	  methods: {
	    ...
	    getFeatureById: function getFeatureById(featureId) {
	      ...
	      return find$3(_context4 = this.$featuresCollection.getArray()).call(_context4, function (feature) {
	    ...
	    getFeatures: function getFeatures() {
	      ...
	      return slice$3(_context5 = this.$featuresCollection.getArray()).call(_context5);
	    },
	...
	var copyConstructorProperties = function (target, source$$1) {
	  var keys = ownKeys(source$$1);
	  var defineProperty = objectDefineProperty.f;
	  var getOwnPropertyDescriptor = objectGetOwnPropertyDescriptor.f;
	  for (var i = 0; i < keys.length; i++) {
	    var key = keys[i];
	    if (!hasOwnProperty_1(target, key)) defineProperty(target, key, getOwnPropertyDescriptor(source$$1, key));
	  }
	};
	...
	var $AggregateError = function AggregateError(errors, message /* , options */) {
	  ...
	  if (objectSetPrototypeOf) {
	    that = objectSetPrototypeOf(new Error$1(undefined), objectGetPrototypeOf(that));
	  }
	  createNonEnumerableProperty(that, 'message', normalizeStringArgument(message, ''));
	  if (errorStackInstallable) createNonEnumerableProperty(that, 'stack', clearErrorStack(that.stack, 1));
	  installErrorCause(that, options);
	  var errorsArray = [];
	  iterate(errors, push$7, { that: errorsArray });
	      ...
	      try {
	        if (handler) {
	          ...
	          if (result === reaction.promise) {
	            reject(TypeError$k('Promise-chain cycle'));
	...
	var internalResolve = function (state, value, unwrap) {
	  ...
	  if (unwrap) state = unwrap;
	  try {
	    if (state.facade === value) throw TypeError$k("Promise can't be resolved itself");
	...
	function multiMergeDescriptors() {
	  ...
	  return slice$3(args).call(args, 1).reduce(function (dest, src, i) {
	...
	function first(predicate, defaultValue) {
	    ...
	    return function (source$$1) { return source$$1.pipe(predicate ? filter$5(function (v, i) { return predicate(v, i, source$$1); }) : identity$1, take(1), hasDefaultValue ? defaultIfEmpty(defaultValue) : throwIfEmpty(function () { return new EmptyError(); })); };
	}
	...
	var cmp = {
	  ...
	  computed: {
	    ...
	    vmId: function vmId() {
	      ...
	      return filter$3(_context = [this.cmpName, this.id]).call(_context, identity).join('-');
	    },
	    vmName: function vmName() {
	      var _context2;

	      return filter$3(_context2 = [this.cmpName, this.id]).call(_context2, identity).join(' ');
	    },
	  ...
	  methods: {
	    ...
	    deinit: function deinit() {
	      ...
	      if (this._olObject) {
	        ...
	        this._olObject[VM_PROP] = filter$3(_context5 = this._olObject[VM_PROP]).call(_context5, function (vm) {
	          return vm !== _this2;
	        });
	...
	function defineServices$1() {
	  ...
	  Object.defineProperties(this, {
	    ...
	    $map: {
	      enumerable: true,
	      get: function get() {
	        return _this3.$services && map$3(_this3.$services);
	      }
	    },
	...
	function subscribeToGeomChanges() {
	  ...
	  }).pipe(throttleTime(ft), distinctUntilChanged(isEqualGeom), map$5(function (_ref) {
	...
	function ownKeys$4(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function defineServices$4() {
	  ...
	  Object.defineProperties(this, {
	    ...
	    $map: {
	      enumerable: true,
	      get: function get() {
	        return _this2.$services && map$3(_this2.$services);
	      }
	    },
	    $view: {
	      enumerable: true,
	...
	var sort$1 = function (it) {
	  var own = it.sort;
	  return it === ArrayPrototype$9 || (objectIsPrototypeOf(ArrayPrototype$9, it) && own === ArrayPrototype$9.sort) ? sort : own;
	};
	...
	var interactionsContainer = {
	  ...
	  computed: {
	    interactionIds: function interactionIds() {
	      ...
	      if (!this.rev) return [];
	      return map$3(_context = this.getInteractions()).call(_context, getInteractionId);
	    },
	  ...
	  methods: {
	    ...
	    getInteractions: function getInteractions() {
	      ...
	      return slice$3(_context2 = this.$interactionsCollection.getArray()).call(_context2);
	    },
	    ...
	    getInteractionById: function getInteractionById(interactionId) {
	      ...
	      return find$3(_context3 = this.$interactionsCollection.getArray()).call(_context3, function (interaction$$1) {
	    ...
	    sortInteractions: function sortInteractions(sorter) {
	      ...
	      sort$3(_context4 = this.$interactionsCollection.getArray()).call(_context4, sorter);
	    },
	...
	function ownKeys$5(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var layersContainer = {
	  ...
	  computed: {
	    layerIds: function layerIds() {
	      ...
	      if (!this.rev) return [];
	      return map$3(_context = this.getLayers()).call(_context, getLayerId);
	    },
	  ...
	  methods: {
	    ...
	    getLayers: function getLayers() {
	      ...
	      return slice$3(_context2 = this.$layersCollection.getArray()).call(_context2);
	    },
	    ...
	    getLayerById: function getLayerById(layerId) {
	      ...
	      return find$3(_context3 = this.$layersCollection.getArray()).call(_context3, function (layer) {
	...
	var overlaysContainer = {
	  ...
	  computed: {
	    overlayIds: function overlayIds() {
	      ...
	      if (!this.rev) return [];
	      return map$3(_context = this.getOverlays()).call(_context, getOverlayId);
	    },
	  ...
	  methods: {
	    ...
	    getOverlays: function getOverlays() {
	      ...
	      return slice$3(_context2 = this.$overlaysCollection.getArray()).call(_context2);
	    },
	    ...
	    getOverlayById: function getOverlayById(overlayId) {
	      ...
	      return find$3(_context3 = this.$overlaysCollection.getArray()).call(_context3, function (overlay) {
	  ...
	  methods: {
	    ...
	    removeStyle: function removeStyle(style$$1) {
	      ...
	      if (currentStyles === style$$1) {
	        ...
	        currentStyles = filter$3(currentStyles).call(currentStyles, function (s) {
	...
	*/
	...
	function ownKeys$6(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function ownKeys$7(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	  ...
	  watch: _objectSpread$6({
	    featuresDataProj: {
	      ...
	      handler: dist(function (features) {
	        this.$emit('update:features', slice$3(features).call(features));
	      }, 1000 / 60)
	    }
	...
	function ownKeys$8(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function ownKeys$9(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var values$6 = function (it) {
	  var own = it.values;
	  return it === ArrayPrototype$a || (objectIsPrototypeOf(ArrayPrototype$a, it) && own === ArrayPrototype$a.values)
	    || hasOwnProperty_1(DOMIterables, classof(it)) ? values$5 : own;
	};

	var values$7 = values$6;
	...
	var Builder = /*#__PURE__*/function () {
	  ...
	  _createClass(Builder, [{
	    ...
	    value: function set(key, value) {
	      values$7(this) || (this.values = {});
	      values$7(this)[key] = value;
	    }
	    /**
	     * @return {Cluster}
	     */
	    ...
	    value: function build() {
	      ...
	      source$$1.setProperties(values$7(this));
	      return source$$1;
	    }
	    /**
	    ...
	    value: function promise() {
	      ...
	      return interval(100).pipe(skipWhile(function () {
	        return !_this.source;
	      }), first(), map$5(this.build.bind(this))).toPromise(promise$5);
	    }
	  }]);
	...
	function ownKeys$a(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function ownKeys$b(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	  ...
	  methods: {
	    ...
	    getDefaultStyles: function getDefaultStyles() {
	      var defaultStyles = mapValues(defaultEditStyle(), function (styles) {
	        return map$3(styles).call(styles, createStyle);
	      });
	...
	function subscribeToInteractionChanges() {
	  ...
	  hasInteraction(this);
	  var drawEvents = merge(fromOlEvent(this.$interaction, 'drawstart').pipe(map$5(function (evt) {
	...
	function ownKeys$c(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function subscribeToEvents() {
	  ...
	  var changes = fromOlEvent(this.$feature, 'change').pipe(map$5(function () {
	...
	function defineServices$a() {
	  ...
	  Object.defineProperties(this, {
	    ...
	    $map: {
	      enumerable: true,
	      get: function get() {
	        return _this.$services && map$3(_this.$services);
	      }
	    },
	...
	function ownKeys$d(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	  ...
	  computed: {
	    meridians: function meridians() {
	      ...
	      if (this.$graticule && this.rev) {
	        return map$4(this.getMeridians(), function (meridian) {
	    ...
	    parallels: function parallels() {
	      ...
	      if (this.$graticule && this.rev) {
	        return map$4(this.getParallels(), function (parallel) {
	...
	function ownKeys$e(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function ownKeys$f(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function ownKeys$g(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var script$h = {
	  ...
	  watch: _objectSpread$f(_objectSpread$f({}, makeWatchers(['keyboardEventTarget', 'loadTilesWhileAnimating', 'loadTilesWhileInteracting', 'moveTolerance', 'pixelRatio', 'renderer', 'maxTilesLoading'], function () {
	    ...
	    defaultControls: {
	      ...
	      handler: function handler(value) {
	        ...
	        slice$3(_context2 = this._controlsCollection.getArray()).call(_context2).forEach(function (control$$1) {
	          if (control$$1.get('vl_default')) {
	            _this3._controlsCollection.remove(control$$1);
	          }
	        });
	        ...
	        this._controlsCollection.extend(map$3(_context3 = control.defaults(value).getArray()).call(_context3, function (control$$1) {
	          control$$1.set('vl_default', true);
	          return control$$1;
	        }));
	      }
	    },
	    defaultInteractions: {
	      ...
	      handler: function handler(value) {
	        ...
	        slice$3(_context4 = this._interactionsCollection.getArray()).call(_context4).forEach(function (interaction$$1) {
	          if (interaction$$1.get('vl_default')) {
	            _this4._interactionsCollection.remove(interaction$$1);
	          }
	        });
	        ...
	        this._interactionsCollection.extend(map$3(_context5 = interaction.defaults(value).getArray()).call(_context5, function (interaction$$1) {
	          interaction$$1.set('vl_default', true);
	          return interaction$$1;
	        }));

	        console.log(slice$3(_context6 = this._interactionsCollection.getArray()).call(_context6));
	      }
	    },
	    wrapX: function wrapX(value) {
	  ...
	  created: function created() {
	    ...
	    this._controlsCollection.forEach(function (control$$1) {
	      control$$1.set('vl_default', true);
	    ...
	    this._interactionsCollection.forEach(function (interaction$$1) {
	      interaction$$1 = initializeInteraction(interaction$$1);
	      interaction$$1.set('vl_default', true);
	...
	function subscribeToEvents$2() {
	  ...
	  }))).pipe(map$5(function (evt) {
	    return _objectSpread$f(_objectSpread$f({}, evt), {}, {
	      coordinate: _this6.pointToDataProj(evt.coordinate)
	    });
	  })); // other
	...
	function ownKeys$h(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	  ...
	  methods: {
	    ...
	    animate: function animate() {
	      ...
	      if (isFunction(args[args.length - 1])) {
	        ...
	        args = slice$3(args).call(args, 0, args.length - 1);
	      }
	      ...
	      return new promise$5(function (resolve) {
	        ...
	        return (_this$$view = _this.$view).animate.apply(_this$$view, concat$5(_context = _toConsumableArray(args)).call(_context, [function (complete) {
	          cb(complete);
	          resolve(complete);
	        }]));
	      });
	    ...
	    fit: function fit(geometryOrExtent) {
	      ...
	      var cb = options.callback || noop$1;
	      return new promise$5(function (resolve) {
	...
	function subscribeToEvents$3() {
	  ...
	  var zoom = resolution.pipe(map$5(function () {
	    return {
	      prop: 'zoom',
	...
	function ownKeys$i(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var computed$6 = {
	  ...
	  classes: function classes() {
	    ...
	    return filter$3(_context2 = [this.cmpName, this.visible ? 'visible' : undefined]).call(_context2, identity);
	  }
	};
	var methods$b = {
	  /**
	  ...
	  mount: function mount() {
	    ...
	    this.$nextTick(function () {
	      ...
	      _this.$overlay.setPosition(slice$3(_context3 = _this.positionViewProj).call(_context3));
	...
	function ownKeys$j(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var script$t = {
	  ...
	  computed: {
	    initializedFeature: function initializedFeature() {
	      ...
	      return map$3(_context = this.features).call(_context, function (feature) {
	...
	function subscribeToInteractionChanges$2() {
	  ...
	  hasInteraction(this);
	  var select = fromOlEvent(this.$featuresCollection, 'add').pipe(map$5(function (_ref) {
	    var element = _ref.element;
	    return {
	      type: 'select',
	      feature: element
	  ...
	  var unselect = fromOlEvent(this.$featuresCollection, 'remove').pipe(map$5(function (_ref2) {
	    var element = _ref2.element;
	    return {
	      type: 'unselect',
	      feature: element
	...
	function ownKeys$k(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var methods$i = {
	  ...
	  setFill: function setFill(fill) {
	    ...
	    var isBg = find$3(_context = this.$slots.background || []).call(_context, function (vnode) {
	  ...
	  setStroke: function setStroke(stroke) {
	    ...
	    var isBg = find$3(_context2 = this.$slots.background || []).call(_context2, function (vnode) {
	...
	function _iterableToArrayLimit(arr, i) {
	  var _i = arr == null ? null : typeof symbol$3 !== "undefined" && getIteratorMethod$3(arr) || arr["@@iterator"];
	...
	function ownKeys$l(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function transformExtent(extent$$1, sourceProj, destProj) {
	  extent$$1 = slice$3(extent$$1).call(extent$$1);
	...
	function ownKeys$m(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function ownKeys$n(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	function ownKeys$o(object, enumerableOnly) { var keys = keys$2(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) { symbols = filter$3(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
