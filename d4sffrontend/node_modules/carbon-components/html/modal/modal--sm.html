...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-esbypwrddrh">Show
  modal</button>

<div data-modal id="modal-esbypwrddrh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-esbypwrddrh-label" aria-describedby="modal-esbypwrddrh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-esbypwrddrh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-esbypwrddrh-heading">Modal heading</p>
