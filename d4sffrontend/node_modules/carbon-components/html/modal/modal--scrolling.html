...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-7qazeifwupb">Show
  modal</button>

<div data-modal id="modal-7qazeifwupb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-7qazeifwupb-label" aria-describedby="modal-7qazeifwupb-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-7qazeifwupb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-7qazeifwupb-heading">Modal heading</p>
