...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-wev43sd2s4n">Show
  modal</button>

<div data-modal id="modal-wev43sd2s4n" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-wev43sd2s4n-label" aria-describedby="modal-wev43sd2s4n-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wev43sd2s4n-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wev43sd2s4n-heading">Modal heading</p>
