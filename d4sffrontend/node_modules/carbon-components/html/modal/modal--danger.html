...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-lpuvhwzvdf">Show
  modal</button>

<div data-modal id="modal-lpuvhwzvdf" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-lpuvhwzvdf-label" aria-describedby="modal-lpuvhwzvdf-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lpuvhwzvdf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lpuvhwzvdf-heading">Modal heading</p>
