...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-c9ema3n2q05">Show
  modal</button>

<div data-modal id="modal-c9ema3n2q05" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-c9ema3n2q05-label" aria-describedby="modal-c9ema3n2q05-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-c9ema3n2q05-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-c9ema3n2q05-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-c9ema3n2q05" class="bx--label">Text Input label</label>
        <input id="text-input-c9ema3n2q05" type="text" class="bx--text-input" placeholder="Optional placeholder text"
