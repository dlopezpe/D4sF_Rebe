...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uyelq82euae">Show
  modal</button>

<div data-modal id="modal-uyelq82euae" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uyelq82euae-label" aria-describedby="modal-uyelq82euae-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uyelq82euae-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uyelq82euae-heading">Modal heading</p>
