...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kupej67kfx">Show
  modal</button>

<div data-modal id="modal-kupej67kfx" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kupej67kfx-label" aria-describedby="modal-kupej67kfx-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kupej67kfx-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kupej67kfx-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
