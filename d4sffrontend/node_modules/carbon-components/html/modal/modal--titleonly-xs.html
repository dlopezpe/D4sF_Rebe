...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gbp2wqp2i3u">Show
  modal</button>

<div data-modal id="modal-gbp2wqp2i3u" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gbp2wqp2i3u-label" aria-describedby="modal-gbp2wqp2i3u-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gbp2wqp2i3u-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gbp2wqp2i3u-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
