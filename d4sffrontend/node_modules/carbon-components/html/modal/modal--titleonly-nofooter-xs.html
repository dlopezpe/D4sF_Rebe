...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-6iszdrkcq54">Show
  modal</button>

<div data-modal id="modal-6iszdrkcq54" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-6iszdrkcq54-label" aria-describedby="modal-6iszdrkcq54-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-6iszdrkcq54-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-6iszdrkcq54-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
