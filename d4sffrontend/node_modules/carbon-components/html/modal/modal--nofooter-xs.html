...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-esuzbm5hf3o">Show
  modal</button>

<div data-modal id="modal-esuzbm5hf3o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-esuzbm5hf3o-label" aria-describedby="modal-esuzbm5hf3o-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-esuzbm5hf3o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-esuzbm5hf3o-heading">Modal heading</p>
