...
df = pd.read_json('plot/order_328671022065868849053340163859520416094.json')
df = df.transpose()
...
axis = dataframe.plot(kind="barh", color=['#ff8000', '#ffdf00', '#66ff98', '#02fefc', '#0087ff', '#2000ff', 'r'])
print(axis)
plt.savefig('plot/plot_img_nubes.png', bbox_inches='tight')
plt.close()
with open('plot/plot_img_nubes.png', "rb") as img_file:
