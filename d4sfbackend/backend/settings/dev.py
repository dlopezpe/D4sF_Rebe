# aplicacion/settings/desarrollo.py
...
# Configuracion específica para desarrollo
# Django Backend
...
DATABASES = {
    'default': {
        ...
        'TIME_ZONE': 'UTC',  # Configurar la zona horaria a UTC
        'OPTIONS': {
            'charset': 'utf8',  # Configurar el conjunto de caracteres a UTF-8
        },
    }
}
...
ENABLED_EMAIL = config('ENABLED_EMAIL', default='False')
